...
def test_check_entity_not_found():
    def pass_None_test():
        try:
            ...
            assert (
                False
            ), "check_entity_not_found does not throw HTTPException when None is passed as entity"
    ...
    def pass_empty_list_test():
        try:
            ...
            assert (
                False
            ), "check_entity_not_found does not throw HTTPException when empty list is passed as entity"
        except HTTPException:
            assert True
